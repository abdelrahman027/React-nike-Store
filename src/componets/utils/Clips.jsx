        ...
        <>
            <div className='relative h-28 w-32 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14 '>
                <img src={imgsrc} alt="img/clips"
                    className='inset-0 flex h-full w-full absolute top-0 left-0 right-0 rounded-xl opacity-100 z-10 transition-opacity duration-500'
                />
                <div className='bg-white blur-effect-them absolute top-11 lg:top-8 lg:left-9 sm:top-4 sm:left-5 left-11 right-0 rounded-xl opacity-100 z-[100] w-8 h-8 md:w-5 md:h-5 flex items-center justify-center rounded-full'>
