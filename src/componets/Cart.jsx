...
import { selectCartItems, selectCartState, setClearCart, selectCartTotalAmount, selectCartTotalQTY } from '../app/CartSlice'
import CartCount from './cart/CartCount'
import CartEmpty from './cart/CartEmpty'
import CartItem from './cart/CartItem'
import { setCloseCart, setGetTotals } from '../app/CartSlice.js'
            ...
            <div className={`fixed top-0 left-0 right-0 bottom-0 blur-effect-theme w-full h-screen opacity-100 z-[250] ${ifCartState ? 'opacity-100 visible translate-x-0' : 'opacity-0 invisible translate-x-8'}`}>
                <div className={`blur-effect-theme h-screen max-w-xl w-full absolute right-0`}>
                    ...
                    {cartItems.length === 0 ? <CartEmpty onCartToggle={onCartToggle} /> :
                        <div>
                            <div className='flex items-start justify-start flex-col gap-y-7 lg:gap-y-5 overflow-y-scroll h-[77vh] scroll-smooth scroll-hidden'>
